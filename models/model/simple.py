...
def model(weights_path=None):
    ...
    _img_1 = BatchNormalization(axis=1, name="img_1_bn_1")(_input_1)
    _img_1 = Conv2D(16, (3, 3), name="img_1_conv_1")(_img_1)
    ...
    _img_1 = Dropout(dp, name="img_1_dp_4")(_img_1)

    _img_1 = GlobalMaxPooling2D()(_img_1)

    _img_2 = BatchNormalization(axis=1, name="img_2_bn_1")(_input_1)
    _img_2 = Conv2D(128, (3, 3), name="img_2_conv_1")(_img_2)
    ...
    # _dense_2 = Dense(64, kernel_regularizer=l2(1e-4), name="dense_2")(_dense_1)
